...
`
    ...
    {
        name: `2025-05-06 업데이트 안내`,
        desc:
            `● 서폿 대개편
            &nbsp;&nbsp; - 서폿 대개편이 완료되었습니다.
            &nbsp;&nbsp; - 계산식과 구조에 대한 자세한 설명은 아래 링크를 참조해주세요.
            &nbsp;&nbsp; - <a href="https://cool-kiss-ec2.notion.site/1eb758f0e8da8065aa70d07656ea2bca?pvs=4" target="_blink" style="color:blue;text-decoration:underline;">서폿 계산 방식</a>
            ...
            &nbsp;&nbsp; - 체크시 악마&대악마 추가피해 옵션이 포함된 점수가 출력됩니다.
            &nbsp;&nbsp; - 달성 최고 점수에는 반영되지 않습니다.

            ● 보석 계산 로직 변경
            &nbsp;&nbsp; - 딜지분 데이터가 없는 캐릭터 & 쿨감 보석은 단순한 평균값으로 제공해왔으나,
            &nbsp;&nbsp; 이제 로그스케일 평균값을 제공합니다.
            &nbsp;&nbsp; - 레벨이 높은 보석의 가치가 올라가고, 낮은 보석의 가치가 내려가게 됩니다.

            ● 타직업 보석의 평균 산출 포함 이슈 수정
            &nbsp;&nbsp; - 공증을 위해 착용한 타직업의 홍염/작열 보석이 평균 산출에 포함되어
            &nbsp;&nbsp; 착용시 오히려 점수가 내려가게 되는 현상을 수정하였습니다.

            ● 시뮬레이터 페이지 상세정보 추가
            &nbsp;&nbsp; - 시뮬레이터에 상세정보 박스를 추가하였습니다.

            ● 에스더 무기 상향
            &nbsp;&nbsp; - 에스더 결속 효과로 인한 딜/버프 증가율을 감안하여,
            &nbsp;&nbsp;  에스더 무기 착용시 아주 약간의 추가 점수를 받도록 수정하였습니다.
            
            ● 광고 차단 프로그램 충돌 이슈 해결
            &nbsp;&nbsp; - 광고 차단 프로그램 사용시 검색이 불가한 현상 해결`
    },
    {
        name: `2025-05-06 핫픽스 안내`,
        desc:
            `● 시뮬레이터 진입시 점수 변동 오류 수정
            &nbsp;&nbsp; - 시뮬레이터 진입시 점수가 상승/하락하는 오류를 수정했습니다.

            ● 일부 광휘의 보석 오류 수정
            &nbsp;&nbsp; - 특정 스킬에 광휘의 보석 착용시 점수가 크게 하락하는 오류를 수정했습니다.
            
            ● 팔찌 효율 계산식 오류 수정
            &nbsp;&nbsp; - 딜러 및 서폿의 팔찌 계산식 오류를 수정했습니다.
            &nbsp;&nbsp; - 점수에는 영향이 없습니다.

            ● 악세 효율 계산식 오류 수정
            &nbsp;&nbsp; - 악세 효율 계산식 오류를 수정했습니다.
            &nbsp;&nbsp; - 점수에는 영향이 없습니다.

            ● 에테르 포식자 효율 관련 안내
            &nbsp;&nbsp; - 현재 에테르 포식자의 효율을 대폭 하향한 상태입니다.
            &nbsp;&nbsp; - 다만 하향 폭이 너무 크다고 판단되어, 다시 소폭 상향을 진행했습니다.`
    },
    {
        name: `2025-05-07 핫픽스 안내`,
        desc:
            `● 도약 포인트 점수 하향
            &nbsp;&nbsp; - 서폿 직업군의 도약 62~68 포인트 구간 점수를 하향 조정했습니다.

            ● 시뮬레이터 오류 수정
            &nbsp;&nbsp; - 팔찌 특성 수치 변경시 가동율 및 버프력이 변하지 않는 오류를 수정했습니다.
            
            ● 서폿 아덴 획득량 목걸이의 밸류에 대한 안내
            &nbsp;&nbsp; - 현재 아덴 획득량 목걸이 및 낙인력의 밸류는, 제가 임의로 점수를 부여한 것이 아닌
            실 효율로 계산되게끔 계산식이 설정되어 있습니다. 
            따라서 스펙에 따라 낙인력의 효율이 더 좋을 수도, 아덴 획득량의 효율이 더 좋을 수도 있는 상황입니다.
            물론 목걸이의 영향을 받지 않는 아덴 수급기가 존재하는 것도 사실입니다만
            해당 사항을 적용할 경우 직업간의 유불리가 생기고, 계산식이 편향적으로 적용되는 문제가 발생합니다.
    ...
    },
    {
        ...
        desc:
            ...
            &nbsp;&nbsp; 로그스케일 평균으로 계산하도록 변경했습니다.
            &nbsp;&nbsp; - 적용 직업군 : 비기, 사시, 교감
            
            ● 오의 배마 보석 점수 뻥튀기 이슈 안내
            &nbsp;&nbsp; - 오의 배마의 보석 점수가 과도하게 적용되던 오류를 수정했습니다.
            &nbsp;&nbsp; 이로 인해 달성 최고 점수 초기화가 필요하신 경우, 문의 주시면 즉시 처리해드리겠습
            &nbsp;&nbsp; 니다. 
            &nbsp;&nbsp;
            &nbsp;&nbsp; 더하여, 오의 배마 역시 이번 밸런스 패치로 구조 개편이 일어났습니다. 현재 기존 데
            &nbsp;&nbsp; 이터를 제거하고 평균 계산으로 제공할 정도로 대격변이 일어났는지 검토 중에 있습
            &nbsp;&nbsp; 니다. 감사합니다.
    ...
    },
    {
        ...
        단, 시뮬레이터는 현재 악세서리 정보를 제대로 불러오지 못하는 오류가 있습니다.
    ...
    },
    {
        ...
        이로 인해 계속해서 점수가 들쭉날쭉하는 점에 대해 진심으로 사과 드립니다.

        현재 깨달음 노드의 점수 반영 부분에서 오류도 발생하고 실수도 발생하여 계속해서 점수가 오르락 내리락 했습니다만
        금일 패치로 인해 어느정도 정상 궤도에 올랐고, 큰 이슈가 없다면 이대로 픽스가 될 것 같습니다.
        감사합니다.
        
        ● 서폿 깨달음 노드 오반영 이슈 해결
        &nbsp;&nbsp; -서폿 직업군의 깨달음 포인트 밸류가 점수에 정상적으로 반영되지 않는 이슈를 해결했습니다.
    ...
    },
    {
        ...
        ● 서폿 직업군 깨달음 밸류 재조정
        &nbsp;&nbsp; - 서폿 직업군의 깨달음 포인트 밸류를 조정하였습니다. 깨달음 포인트가 일정 수치 아래일 경우 점수가 소폭 하락할 수 있습니다.
    ...
    },
    {
        ...
        &nbsp;&nbsp;  더불어, 제가 미처 발견치 못한 기타 오류가 존재할 수 있습니다.
        &nbsp;&nbsp;  오류 발생시 문의 주시면 최대한 빠르게 처리해보도록 하겠습니다.

        &nbsp;&nbsp;  서폿의 경우 점수 개편 작업과 함께 업데이트 될 예정입니다. 
        &nbsp;&nbsp;  7/23 까지 완성을 목표로 하고 있으나, 확답드리긴 어려운 상황입니다.
        &nbsp;&nbsp;  가급적 맞출 수 있도록 열심히 진행해보도록 하겠습니다.

        &nbsp;&nbsp;  마지막으로, 관련 데이터를 공유해주신 귀인께 진심으로 감사의 말씀을 드립니다.`
    },
    {
        name: `2025-07-16 업데이트 안내`,
        desc:
            `● 달성 최고 점수 초기화
            &nbsp;&nbsp; - 아래 패치 내역들로 인해 달성 최고점수 초기화를 진행했습니다.
            
            ● 서폿 1차 개편
        &nbsp;&nbsp; - 이전 임시조치로, 서폿의 깨달음 포인트 밸류를 높여 점수를 상향 조정했었습니다. 
        &nbsp;&nbsp;  이번 패치에서는 서폿의 '깨달음 포인트' 밸류를 제거하고, 각 노드(메인, 사이드)의 
        &nbsp;&nbsp;  실제 효율을 토대로 버프력을 계산한 뒤, 그에 맞춰 점수를 제공합니다.  
        
        &nbsp;&nbsp; 더하여, 임시조치로 과하게 뻥튀기된 서폿의 점수 스케일을 소폭 하향조정 했습니다.
        &nbsp;&nbsp; 스케일은 추후 몇차례 더 조정될 수 있으며, 최대한 빠르게 마무리하도록 하겠습니다.
        &nbsp;&nbsp; 큰 문제가 없다고 판단시 이대로 유지하겠습니다.

        ● 서폿 기준 딜러 변경
        &nbsp;&nbsp; - 상세정보에 표기되는 '버프력'의 기준이 되는 딜러의 스펙을 현재 엔드스펙에 맞춰 상향했습니다. (점수와 무관합니다.)

        ● 공이속 팔찌 하향 조정
        &nbsp;&nbsp; - 공이속 팔찌의 딜증 밸류를 소폭 하향했습니다.

        ● 랭킹 추가
        &nbsp;&nbsp; - 메인 페이지에 임시로 랭킹 데이터를 추가했습니다. 
        &nbsp;&nbsp; 추후 조금 더 깔끔하게 정리하여 별도 페이지를 구현할 예정입니다.`
    },
    {
        name: `25년 7월 3주차 중앙값 통계`,
        desc:
            `7월 3주차 중앙값 통계입니다.
        
        <img src="/asset/image/median-20250718.png">`

    },
    {
        name: `서폿 달성 최고 점수 기록 초기화 안내`,
        desc:
            `안녕하세요, 개발자 청염각입니다.
            현재 서버 이슈 등으로 인해, 서폿 직업군의 달성 최고 점수가 잘못 저장되는 케이스가 다수 발견되었습니다.
            오저장률은 5% 내외로 추정되고 있어 중앙값 데이터 등에는 큰 영향이 없을 것으로 예상되오나
            최상위권 유저의 경우 랭킹 산정 등에 이슈가 발생할 수 있기 때문에 
            부득이하게 초기화 작업을 한번 더 진행할 예정입니다.
            예정 초기화 시각은 오후 8시 쯤입니다. 감사합니다.`
    ...
    {
        name: `2025-07-24 업데이트 안내`,
        desc:
            `● 서폿 직업군의 방어구 품질이 케어력에 반영되지 않는 버그를 수정했습니다.`

    },
    {
        name: `2025-08-01 업데이트 안내 (서폿 점수 초기화)`,
        desc:
            `● 서폿 직업군이 중복된 보석을 착용할 경우 점수가 과도하게 상승하는 오류 수정
            &nbsp;&nbsp; - 최근 적지 않은 빈도로 발생하는 서폿 달성 최고 기록 뻥튀기 이슈의 원인이
            &nbsp;&nbsp; 위 사항일 것이라고 내부적으로 예상하고 있습니다.

            &nbsp;&nbsp; 확실한 원인을 찾아서 해결하는 게 당연히 정답이지만, 여러 요인으로 다소 어려운
            &nbsp;&nbsp; 상황이라, 의심되는 요소들을 하나하나 찾아 나가며 해결해야할 것 같습니다. 

            &nbsp;&nbsp; 이번 버그 수정으로 인한 결과 추이를 지켜보기 위해, 레이드가 얼추 마무리 되는 
            &nbsp;&nbsp; 차주 월요일(08.04) 저녁에 서폿 최고 기록 초기화를 진행할 예정입니다.
            &nbsp;&nbsp; 불편을 드려 죄송합니다. ㅠㅠ `

    },
    {
        name: `2025-08-01 핫픽스 안내`,
        desc:
    ...
    },
    {
        ...
        desc:
            ...
            &nbsp;&nbsp; 서폿의 경우 최대 생명력이 전투력에 영향을 주기 때문에, 
            &nbsp;&nbsp; 레이드 입장 혹은 항해 등의 변수가 상당히 많습니다.
            &nbsp;&nbsp; 최대한 검토를 하긴 했으나, 불가피한 오류가 발생할 수 있습니다.
            &nbsp;&nbsp; 문의를 보내 주시면 최대한 빠르게 조치할 예정입니다.
            &nbsp;&nbsp; 맛있게 써주세요. 감사합니다.`
