...
export async function apiCalcValue(inputName) {
    ...
    console.log(calcValue.completeSpecPoint)
    console.log(dataBase.totalSum)
    console.log(calcValue.completeSpecPoint > dataBase.totalSum)
    ...
    if (
        ...
        Math.floor(calcValue.completeSpecPoint * 100) / 100 > dataBase.totalSum &&          // 계산된 스펙포인트가 DB값보다 큰 경우
