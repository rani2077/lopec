...
export async function getCharacterProfile(data, dataBase) {
    ...
    function medianInfoExtract() {
        ...
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.dealerMedianValue = 910.42;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.dealerMedianValue = 972.92;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.dealerMedianValue = 1002.70;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.dealerMedianValue = 1035.88;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.dealerMedianValue = 1432.96;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.dealerMedianValue = 1593.97;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.dealerMedianValue = 1655.91;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.dealerMedianValue = 1757.69;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.dealerMedianValue = 1872.53;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.dealerMedianValue = 2030.79;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.dealerMedianValue = 2115.46;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.dealerMedianValue = 2175.71;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.dealerMedianValue = 2284.53;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.dealerMedianValue = 2416.01;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.dealerMedianValue = 2565.67;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.dealerMedianValue = 2744.37;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.dealerMedianValue = 2932.74;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.dealerMedianValue = 3201.63;
        } else if (itemLevel >= 1750) {
            result.dealerMedianValue = 3507.50;
        }

        // console.log(itemLevel)
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.supportMedianValue = 1047.18;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.supportMedianValue = 1051.06;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.supportMedianValue = 1142.53;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.supportMedianValue = 1166.05;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.supportMedianValue = 1450.60;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.supportMedianValue = 1552.43;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.supportMedianValue = 1614.23;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.supportMedianValue = 1687.99;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.supportMedianValue = 1804.74;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.supportMedianValue = 1965.60;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.supportMedianValue = 2066.13;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.supportMedianValue = 2152.27;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.supportMedianValue = 2250.64;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.supportMedianValue = 2469.77;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.supportMedianValue = 2668.23;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.supportMedianValue = 2891.42;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.supportMedianValue = 3059.73;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.supportMedianValue = 3295.11;
        } else if (itemLevel >= 1750) {
            result.supportMedianValue = 3643.47;
        }
