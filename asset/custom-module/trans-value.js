...
export async function getCharacterProfile(data, dataBase) {
    ...
    function medianInfoExtract() {
        ...
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.dealerMedianValue = 911.24;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.dealerMedianValue = 982.16;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.dealerMedianValue = 1002.03;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.dealerMedianValue = 1041.16;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.dealerMedianValue = 1431.98;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.dealerMedianValue = 1600.36;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.dealerMedianValue = 1655.42;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.dealerMedianValue = 1756.24;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.dealerMedianValue = 1872.06;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.dealerMedianValue = 2029.76;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.dealerMedianValue = 2115.70;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.dealerMedianValue = 2173.60;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.dealerMedianValue = 2282.94;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.dealerMedianValue = 2419.61;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.dealerMedianValue = 2568.01;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.dealerMedianValue = 2745.35;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.dealerMedianValue = 2932.52;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.dealerMedianValue = 3197.71;
        } else if (itemLevel >= 1750) {
            result.dealerMedianValue = 3500.68;
        }

        // console.log(itemLevel)
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.supportMedianValue = 1098.09;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.supportMedianValue = 1207.64;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.supportMedianValue = 1142.53;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.supportMedianValue = 1158.95;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.supportMedianValue = 1454.21;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.supportMedianValue = 1521.99;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.supportMedianValue = 1611.35;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.supportMedianValue = 1679.39;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.supportMedianValue = 1808.44;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.supportMedianValue = 1953.83;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.supportMedianValue = 2068.04;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.supportMedianValue = 2153.40;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.supportMedianValue = 2266.06;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.supportMedianValue = 2497.75;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.supportMedianValue = 2679.36;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.supportMedianValue = 2903.97;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.supportMedianValue = 3046.41;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.supportMedianValue = 3272.76;
        } else if (itemLevel >= 1750) {
            result.supportMedianValue = 3633.74;
        }
