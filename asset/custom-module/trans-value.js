...
//
    ...
    function medianInfoExtract() {
        ...
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.dealerMedianValue = 910.41;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.dealerMedianValue = 970.43;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.dealerMedianValue = 995.38;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.dealerMedianValue = 1041.16;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.dealerMedianValue = 1432.78;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.dealerMedianValue = 1593.66;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.dealerMedianValue = 1657.09;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.dealerMedianValue = 1752.90;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.dealerMedianValue = 1871.96;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.dealerMedianValue = 2031.77;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.dealerMedianValue = 2119.10;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.dealerMedianValue = 2172.97;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.dealerMedianValue = 2285.62;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.dealerMedianValue = 2413.24;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.dealerMedianValue = 2560.68;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.dealerMedianValue = 2731.17;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.dealerMedianValue = 2927.06;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.dealerMedianValue = 3198.93;
        } else if (itemLevel >= 1750 && itemLevel < 1755.001) {
            result.dealerMedianValue = 3495.78;
        } else if (itemLevel >= 1755.001) {
            result.dealerMedianValue = 3894.75;
        }

        // console.log(itemLevel)
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.supportMedianValue = 1057.56;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.supportMedianValue = 1051.06;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.supportMedianValue = 1139.27;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.supportMedianValue = 1180.69;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.supportMedianValue = 1450.34;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.supportMedianValue = 1561.06;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.supportMedianValue = 1609.35;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.supportMedianValue = 1696.23;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.supportMedianValue = 1808.61;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.supportMedianValue = 1972.87;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.supportMedianValue = 2058.68;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.supportMedianValue = 2141.53;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.supportMedianValue = 2255.44;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.supportMedianValue = 2445.77;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.supportMedianValue = 2646.71;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.supportMedianValue = 2865.20;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.supportMedianValue = 3056.42;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.supportMedianValue = 3307.65;
        } else if (itemLevel >= 1750 && itemLevel < 1755.001) {
            result.supportMedianValue = 3640.38;
        } else if (itemLevel >= 1755.001) {
            result.supportMedianValue = 4248.20;
        }
