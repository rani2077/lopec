...
export async function getCharacterProfile(data, dataBase) {
    ...
    function medianInfoExtract() {
        ...
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.dealerMedianValue = 916.44;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.dealerMedianValue = 948.96;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.dealerMedianValue = 1015.91;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.dealerMedianValue = 1041.16;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.dealerMedianValue = 1428.12;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.dealerMedianValue = 1591.23;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.dealerMedianValue = 1647.93;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.dealerMedianValue = 1761.16;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.dealerMedianValue = 1863.10;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.dealerMedianValue = 2025.66;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.dealerMedianValue = 2098.34;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.dealerMedianValue = 2152.77;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.dealerMedianValue = 2272.01;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.dealerMedianValue = 2426.83;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.dealerMedianValue = 2567.82;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.dealerMedianValue = 2739.75;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.dealerMedianValue = 2920.09;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.dealerMedianValue = 3188.00;
        } else if (itemLevel >= 1750) {
            result.dealerMedianValue = 3489.31;
        }

        // console.log(itemLevel)
        if (itemLevel >= 1660 && itemLevel < 1665) {
            result.supportMedianValue = 1079.91;
        } else if (itemLevel >= 1665 && itemLevel < 1670) {
            result.supportMedianValue = 1105.44;
        } else if (itemLevel >= 1670 && itemLevel < 1675) {
            result.supportMedianValue = 1170.09;
        } else if (itemLevel >= 1675 && itemLevel < 1680) {
            result.supportMedianValue = 1216.40;
        } else if (itemLevel >= 1680 && itemLevel < 1685) {
            result.supportMedianValue = 1448.85;
        } else if (itemLevel >= 1685 && itemLevel < 1690) {
            result.supportMedianValue = 1586.92;
        } else if (itemLevel >= 1690 && itemLevel < 1695) {
            result.supportMedianValue = 1616.68;
        } else if (itemLevel >= 1695 && itemLevel < 1700) {
            result.supportMedianValue = 1736.90;
        } else if (itemLevel >= 1700 && itemLevel < 1705) {
            result.supportMedianValue = 1821.61;
        } else if (itemLevel >= 1705 && itemLevel < 1710) {
            result.supportMedianValue = 1964.80;
        } else if (itemLevel >= 1710 && itemLevel < 1715) {
            result.supportMedianValue = 2057.04;
        } else if (itemLevel >= 1715 && itemLevel < 1720) {
            result.supportMedianValue = 2155.11;
        } else if (itemLevel >= 1720 && itemLevel < 1725) {
            result.supportMedianValue = 2254.41;
        } else if (itemLevel >= 1725 && itemLevel < 1730) {
            result.supportMedianValue = 2469.95;
        } else if (itemLevel >= 1730 && itemLevel < 1735) {
            result.supportMedianValue = 2665.29;
        } else if (itemLevel >= 1735 && itemLevel < 1740) {
            result.supportMedianValue = 2871.96;
        } else if (itemLevel >= 1740 && itemLevel < 1745) {
            result.supportMedianValue = 3035.06;
        } else if (itemLevel >= 1745 && itemLevel < 1750) {
            result.supportMedianValue = 3210.97;
        } else if (itemLevel >= 1750) {
            result.supportMedianValue = 3531.92;
        }
